...
Route::middleware(['admin'])->name('admin.')->prefix('admin')->group(function () {
    ...
    Route::get('/student/student/class/{student_id}', [RelationShipController::class, 'classes_student'])->name('class.student');
    Route::get('/create/student/student/class', [RelationShipController::class, 'create_classes_student'])->name('create.class.student');
    Route::post('/store/student/student/class', [RelationShipController::class, 'store_classes_student'])->name('store.class.student');

    Route::get('/student/student/subject/{student_id}', [RelationShipController::class, 'subjects_student'])->name('subject.student');
    Route::get('/create/student/student/subject', [RelationShipController::class, 'create_subjects_student'])->name('create.subject.student');
    Route::post('/store/student/student/subject', [RelationShipController::class, 'store_subjects_student'])->name('store.subject.student');
