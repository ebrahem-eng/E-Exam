...
<head>
    ...
    <title>Add Subjects In Class</title>
                ...
                <div class="col-lg-6 mt-5 mx-auto">
                    <div class="card  mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Add Subject In Class</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.class.subject.store') }}">
                                @csrf

                                <div class="mb-3">
                                    <label class="form-label" for="basic-icon-default-email">Class Name</label>
                                    <div class="input-group input-group-merge">
                                        
                                        <input type="text" class="form-control" name="class_name"
                                            value="{{ $class_name }}" readonly required />
