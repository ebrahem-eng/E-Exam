...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets_welcome/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets_welcome/css/jquery-ui.css') }}">
    <link rel="stylesheet" href="{{ asset('assets_welcome/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets_welcome/css/owl.theme.default.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets_welcome/css/owl.theme.default.min.css') }}">

    <link rel="stylesheet" href="{{ asset('assets_welcome/css/jquery.fancybox.min.css') }}">

    <link rel="stylesheet" href="{{ asset('assets_welcome/css/bootstrap-datepicker.css') }}">

    <link rel="stylesheet" href="{{ asset('assets_welcome/fonts/flaticon/font/flaticon.css') }}">

    <link rel="stylesheet" href="{{ asset('assets_welcome/css/aos.css') }}">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap">
        ...
        <div class="intro-section" id="home-section">
            ...
            <div class="slide-1" style="background-image: url('assets_welcome/images/hero_1.jpg');"
                ...
                <div class="row">
                    ...
                    <div class="owl-carousel col-12 nonloop-block-14">
                        ...
                        <div class="course bg-white h-100 align-self-stretch">
                            <figure class="m-0">
                                <a href="course-single.html"><img
                                        src="{{ asset('assets_welcome/images/img_1.jpg') }}" alt="Image"
                                        class="img-fluid"></a>
                            </figure>
                        ...
                        <div class="course bg-white h-100 align-self-stretch">
                            <figure class="m-0">
                                <a href="course-single.html"><img
                                        src="{{ asset('assets_welcome/images/img_2.jpg') }}" alt="Image"
                                        class="img-fluid"></a>
                            </figure>
                            <div class="course-inner-text py-4 px-4">
                        ...
                        <div class="course bg-white h-100 align-self-stretch">
                            <figure class="m-0">
                                <a href="course-single.html"><img
                                        src="{{ asset('assets_welcome/images/img_3.jpg') }}" alt="Image"
                                        class="img-fluid"></a>
                            </figure>
                            <div class="course-inner-text py-4 px-4">
                                <span class="course-price">$99</span>
                        ...
                        <div class="course bg-white h-100 align-self-stretch">
                            <figure class="m-0">
                                <a href="course-single.html"><img
                                        src="{{ asset('assets_welcome/images/img_4.jpg') }}" alt="Image"
                                        class="img-fluid"></a>
                            </figure>
                            <div class="course-inner-text py-4 px-4">
                                <span class="course-price">$20</span>
                        ...
                        <div class="course bg-white h-100 align-self-stretch">
                            <figure class="m-0">
                                <a href="course-single.html"><img
                                        src="{{ asset('assets_welcome/images/img_5.jpg') }}" alt="Image"
                                        class="img-fluid"></a>
                            </figure>
                            <div class="course-inner-text py-4 px-4">
                                <span class="course-price">$99</span>
                        ...
                        <div class="course bg-white h-100 align-self-stretch">
                            <figure class="m-0">
                                <a href="course-single.html"><img
                                        src="{{ asset('assets_welcome/images/img_6.jpg') }}" alt="Image"
                                        class="img-fluid"></a>
                            </figure>
                            <div class="course-inner-text py-4 px-4">
                                <span class="course-price">$99</span>
            ...
            <div class="container">
                ...
                <div class="row mb-5 align-items-center">
                    <div class="col-lg-7 mb-5" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ asset('assets_welcome/images/undraw_youtube_tutorial.svg') }}" alt="Image"
                            class="img-fluid">
                    </div>
                ...
                <div class="row mb-5 align-items-center">
                    <div class="col-lg-7 mb-5 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ asset('assets_welcome/images/undraw_teaching.svg') }}" alt="Image"
                            class="img-fluid">
                    </div>
                ...
                <div class="row mb-5 align-items-center">
                    <div class="col-lg-7 mb-5" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ asset('assets_welcome/images/undraw_teacher.svg') }}" alt="Image"
                            class="img-fluid">
                    </div>
                    <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="teacher text-center">
                            <img src="{{ asset('assets_welcome/images/person_1.jpg') }}" alt="Image"
                    ...
                    <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="teacher text-center">
                            <img src="{{ asset('assets_welcome/images/person_2.jpg') }}" alt="Image"
                                class="img-fluid w-50 rounded-circle mx-auto mb-4">
                            <div class="py-2">
                    ...
                    <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
                        <div class="teacher text-center">
                            <img src="{{ asset('assets_welcome/images/person_3.jpg') }}" alt="Image"
                                class="img-fluid w-50 rounded-circle mx-auto mb-4">
                            <div class="py-2">
        ...
        <div class="site-section bg-image overlay" style="background-image: url('assets_welcome/images/hero_1.jpg');">
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-md-8 text-center testimony">
                        <img src="{{ asset('assets_welcome/images/person_4.jpg') }}" alt="Image"
        ...
        <div class="site-section pb-0">
            ...
            <div class="future-blobs">
                <div class="blob_2">
                    <img src="{{ asset('assets_welcome/images/blob_2.svg') }}" alt="Image">
                </div>
                <div class="blob_1">
                    <img src="{{ asset('assets_welcome/images/blob_1.svg') }}" alt="Image">
                </div>
            </div>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 align-self-end" data-aos="fade-left" data-aos-delay="200">
                        <img src="{{ asset('assets_welcome/images/person_transparent.png') }}" alt="Image"
                            class="img-fluid">
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('assets_welcome/js/jquery-3.3.1.min.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/jquery-migrate-3.0.1.min.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/jquery-ui.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/popper.min.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/jquery.stellar.min.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/jquery.countdown.min.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/bootstrap-datepicker.min.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/jquery.easing.1.3.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/aos.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/jquery.fancybox.min.js') }}"></script>
    <script src="{{ asset('assets_welcome/js/jquery.sticky.js') }}"></script>
