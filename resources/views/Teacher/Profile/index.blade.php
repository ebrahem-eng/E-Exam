                            ...
                            <div class="nav-align-top mb-4">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="navs-pills-justified-home"
                                        ...
                                        <form method="post"
                                            action="{{ route('teacher.profile.personal.update', $teachers->id) }}">
                                            @method('put')
                                            @csrf
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            name="name" value="{{ $teachers->name }}" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="date" class="form-control" placeholder=""
                                                            value="{{ $teachers->birthday }}" name="birthday"  required/>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="navs-pills-justified-profile" role="tabpanel">
                                        ...
                                        <div class="tab-pane fade show active" id="navs-pills-justified-home"
                                            ...
                                            <form method="post"
                                                action="{{ route('teacher.profile.reset.password.update', $teachers->id) }}">
                                                @method('put')
                                                @csrf
                                    ...
                                    <div class="tab-pane fade" id="navs-pills-justified-messages" role="tabpanel">
                                        ...
                                        <form method="post"
                                            action="{{ route('teacher.profile.contact.update', $teachers->id) }}">
                                            @method('put')
                                            @csrf
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="email" class="form-control"
                                                            ...
                                                            aria-describedby="basic-icon-default-fullname2"
                                                            name="email" value="{{ $teachers->email }}" readonly
                                                            required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="tel" class="form-control"
                                                            placeholder="0987654321" value="{{ $teachers->phone }}"
                                                            name="phone" />
                                                    </div>
                                                </div>
                                            </div>
